...
from src.api.servers import servers_api
...
from src.api.soundpad import soundpad_api
...
app.include_router(servers_api, prefix='/servers')
...
app.include_router(statistics_api, prefix='/statistics')
...
app.include_router(soundpad_api, prefix='/soundpad')